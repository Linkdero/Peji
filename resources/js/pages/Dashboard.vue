...
export default {
    ...
    methods: {
        async getCargarModulos() {
            try {
                const response = await axios.get('/apiModulo/modulos/getModulosSubModulosActivos');
                this.modulos = response.data;
                console.log('Módulos y componentes cargados:', this.modulos);
                // Cargar componentes dinámicamente
                await this.setComponentesDinamicos();
            } catch (error) {
        ...
        async setComponentesDinamicos() {
            for (const m of this.modulos) {
                if (m.sub_modulos) {
                    for (const sm of m.sub_modulos) {
                        const nombreComponente = sm.sub_modulo_detalle.replace(/\s+/g, '');
                        try {
                            // Importación dinámica con ruta relativa desde tus views
                            const component = await import(`@/components/Peji-Admin/views/${m.modulo_detalle}/${nombreComponente}.vue`);
                            this.componenteDinamico[nombreComponente] = component.default;
                        } catch (e) {
                            console.warn(`No se pudo cargar el componente ${nombreComponente}:`, e);
                        }
                    }
                }
            }
    ...
    computed: {
        componenteActual() {
            ...
            const component = this.$page.props.component;
            // Buscar en componentes dinámicos
            if (component && this.componenteDinamico[component]) {
                return this.componenteDinamico[component];
            }
            // Componente por defecto o manejo de error
            return this.componenterDefault
        }
    }
}
</script>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                                ...
                                                <div class="mb-3 mb-md-0 fw-semibold">
                                                    ...
                                                    <div class="fs-6 text-gray-700 pe-7">Login into Admin Dashboard
                                                        to
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex flex-column me-3">
                            ...
                            <div class="mb-3">
                                ...
                                <span class="text-gray-500 fw-semibold d-block">The best kitchen gadget in
                                    2022</span>
                            </div>
                            <!--end::Section-->
                            <!--begin::Section-->
